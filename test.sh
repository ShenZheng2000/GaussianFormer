...
# # # v2 results (#6400) (retest: 20.01, report: 20.04)
# MASTER_PORT=20508 python eval.py --py-config config/prob/nuscenes_gs6400.py \
#      --work-dir out/nuscenes_gs6400/ \
#      --resume-from out/nuscenes_gs6400/state_dict.pth

# # v2 results (#6400, half res)
# MASTER_PORT=20508 python eval.py --py-config config/prob/nuscenes_gs6400_halfres.py \
#      --work-dir out/nuscenes_gs6400/ \
#      --resume-from out/nuscenes_gs6400/state_dict.pth
